...
public class VirtualKey {
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String st;
		File mFolder = new File("C:\\Users\\hp\\Desktop\\COOL");
		mFolder.mkdir();
		String location = "C:\\Users\\hp\\Desktop\\COOL";
		...
		do {
			...
			switch (choice) {
			case 1:
				File Fobj = new File("C:\\Users\\hp\\Desktop\\COOL");
			...
			case 2:
				do {
					...
					case 3:
						...
						st = sc.next();
						File fsearch = new File("C:\\Users\\hp\\Desktop\\COOL");
